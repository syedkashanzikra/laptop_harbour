...
class BrandCardscreen extends StatelessWidget {
  ...
  Future<List<QueryDocumentSnapshot>> fetchProduct() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        ...
        .doc(categoryId) // Use the provided category ID
        .collection(
            'two') // Specify the subcollection name ('two' in this case)
        .get();
    ...
    return FutureBuilder(
        ...
        builder:
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            String brandName = snapshot.data![0]['brand'];
            return Scaffold(
                appBar: AppBar(
                  leading: IconButton(
                    icon: Icon(
